...
export default function SkillCard({
  ...
  return (
    <div className="group relative grayscale transition-all duration-500 hover:filter-none">
      <div
        className={cn(
          'absolute inset-2 bg-primary transition-all duration-200 group-hover:animate-pulse group-hover:blur'
          // {
      ...
      <div
        className={cn(
          'relative flex flex-col items-center justify-center gap-2 rounded-md border border-gray-200 bg-white px-3 py-4 transition-all duration-500 hover:border-primary/20'
          // {
          //   'hover:border-sky-500': color === 'sky',
          //   'hover:border-green-200': color === 'orange',
